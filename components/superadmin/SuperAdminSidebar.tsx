...
import { LayoutDashboard, Building2, Users, Settings, Database, ShieldAlert, LogOut, Terminal, Activity } from 'lucide-react';
...
const SuperAdminSidebar = ({ onLogout }: SidebarProps) => {
  ...
  return (
    <aside className="w-72 bg-gray-900 border-r border-gray-800 h-screen sticky top-0 flex flex-col p-6">
      <div className="flex items-center gap-3 mb-12">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[10px] font-black text-brand-500 uppercase tracking-[0.2em]">Super Admin</span>
        </div>
      </div>
      ...
      <nav className="flex-1 space-y-2">
        ...
        <NavLink to="/superadmin/users" className={navClasses}>
          <Users size={18} />
          All Users
        </NavLink>
      ...
      <div className="mt-auto pt-6 border-t border-gray-800">
        <div className="flex items-center gap-3 p-4 bg-white/5 rounded-2xl mb-4">
           ...
           <span className="text-xs font-bold text-gray-400">System: Healthy</span>
        </div>
        <button 
          onClick={onLogout}
